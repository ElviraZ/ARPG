...
public class UIName
{
	...
	public const string UIBattleVictory = "UIBattle_Victory";
}
public class UIManager : MonoSingleton<UIManager> {
	...
	//显示开始游戏场景一级界面
	public void SetGameStartVisible(bool visible)
	{
		SetVisible(UIName.UIGameVersion, visible);
	}
	...
	public void SetBattleVisisble(bool visible)
	{
